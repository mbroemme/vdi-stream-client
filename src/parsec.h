...
/*
 * Private frame formats generated by vdi-stream-client decoders.  These values
 * intentionally live outside the public ParsecColorFormat enum range used by
 * the SDK.  They are only emitted by our injected FFmpeg decoder and consumed
 * by our local renderer.
 */
#define VDI_STREAM_CLIENT_FORMAT_VUYX ((ParsecColorFormat) 1000)
